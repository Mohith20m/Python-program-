...
Label(root,text="Python Registartion Form",font="arial 25").pack(pady=50)
...
Button(text="Registration",font=20,width=11,height=2,command=registration).place(x=250,y=380)
